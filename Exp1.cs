...
public class Exp1 : MonoBehaviour
{
    ...
    void Start()
    {
        EXPData = DateTime.Now.ToString("yyyyMMddHHmmssffff");
    ...
    void Update()
    {
        if (current_state == "Practice")
        {
            ...
            UI[2].GetComponent<Text>().text = Trials[RandomIndex, 1].ToString() + " 人";
        ...
        else
        {
            if (current_state == "Experiment")
            {
                ...
                UI[2].GetComponent<Text>().text = Trials[trial_current, 1].ToString() + " 人";
                UI[3].GetComponent<Toggle>().isOn = controller.GetComponent<UpsyVR_ControllerEvents>().Right_Trigger;
                ////////////////////////////////////////
